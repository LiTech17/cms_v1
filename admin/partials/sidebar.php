...
<aside id="sidebar" class="sidebar">
    <div class="sidebar-header">
        <h2>NGO CMS</h2>
        <button id="toggleSidebar" title="Collapse sidebar">☰</button>
    </div>
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <li><a href="about_page.php"><i class="fas fa-university"></i> About Page</a></li>
            <li><a href="operational_bases.php"><i class="fas fa-map-marker-alt"></i> Operational Bases</a></li>
